 ...
 */
static BOOL EaseProxy_isInterceptedSelector(SEL sel) {
    return (
...
@interface EaseModuleAdapterProxy () {
    __weak id _collectionViewTarget;
    __weak id _scrollViewTarget;
    __weak id<EaseModuleDataSourceAble> _dataSource;
}

@end

@implementation EaseModuleAdapterProxy
...
- (BOOL)respondsToSelector:(SEL)aSelector {
    return EaseProxy_isInterceptedSelector(aSelector)
...
- (id)forwardingTargetForSelector:(SEL)aSelector {
    ...
    if (EaseProxy_isInterceptedSelector(aSelector)) {
        return _dataSource;
    }
