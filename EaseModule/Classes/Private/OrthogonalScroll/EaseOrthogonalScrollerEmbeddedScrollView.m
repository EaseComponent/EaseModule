//
//  EaseOrthogonalScrollerEmbeddedScrollView.m
//  EaseModule
//
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _orthogonalScrollView = [[EaseOrthogonalScrollerEmbeddedScrollView alloc] initWithFrame:CGRectZero collectionViewLayout:({
            EaseModuleFlowLayout * layout = EaseModuleFlowLayout.new;
...
@implementation EaseOrthogonalScrollerEmbeddedScrollView
...
#pragma mark - EaseModuleFlowLayout
...
- (EaseComponent *)collectionView:(UICollectionView *)collectionView layout:(EaseModuleFlowLayout *)collectionViewLayout componentAtSection:(NSInteger)section{
    if ([self.collectionView.dataSource isKindOfClass:[EaseModuleDataSource class]]) {
        EaseModuleDataSource * dataSource = (EaseModuleDataSource *)self.collectionView.dataSource;
