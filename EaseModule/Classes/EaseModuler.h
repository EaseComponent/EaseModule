...
//! Project version number for EaseModuler.
FOUNDATION_EXPORT double EaseModulerVersionNumber;

//! Project version string for EaseModuler.
FOUNDATION_EXPORT const unsigned char EaseModulerVersionString[];
